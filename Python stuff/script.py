...
# need to use colors after the cord functions 
total_events = one_location_cord  + bellator_location_cord + ufc_location_cord 
total_events_color = marker_color(total_events)

total_events_sorted = sorted(total_events_color, key = lambda event:event["Date"])
